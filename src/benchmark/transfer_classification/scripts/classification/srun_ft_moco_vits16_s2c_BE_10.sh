...
#SBATCH --output=srun_outputs/classification/BE_moco_FT_vits16_10_%j.out
#SBATCH --error=srun_outputs/classification/BE_moco_FT_vits16_10_%j.err
...
--bands all \
--checkpoints_dir /p/project/hai_ssl4eo/wang_yi/ssl4eo-s12-dataset/src/benchmark/fullset_temp/checkpoints/moco_ft/BE_vits16_10 \
--arch vit_small \
--train_frac 0.1 \
--batch_size 64 \
--lr 0.01 \
