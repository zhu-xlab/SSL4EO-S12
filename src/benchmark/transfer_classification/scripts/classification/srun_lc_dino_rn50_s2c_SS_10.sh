...
#SBATCH --output=srun_outputs/classification/SS_dino_LC_rn50_10_%j.out
#SBATCH --error=srun_outputs/classification/SS_dino_LC_rn50_10_%j.err
...
--bands B13 \
--checkpoints_dir /p/project/hai_ssl4eo/wang_yi/ssl4eo-s12-dataset/src/benchmark/fullset_temp/checkpoints/dino_lc/SS_rn50_10 \
--arch resnet50 \
--train_frac 0.1 \
