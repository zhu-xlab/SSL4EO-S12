...
#SBATCH --output=srun_outputs/classification/BE_sup_rn50_1_%j.out
#SBATCH --error=srun_outputs/classification/BE_sup_rn50_1_%j.err
...
--bands all \
--checkpoints_dir /p/project/hai_ssl4eo/wang_yi/ssl4eo-s12-dataset/src/benchmark/fullset_temp/checkpoints/moco_sup/BE_rn50_1 \
--backbone resnet50 \
--train_frac 0.01 \
--batchsize 64 \
--lr 0.05 \
