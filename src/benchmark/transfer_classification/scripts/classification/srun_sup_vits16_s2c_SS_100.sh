...
#SBATCH --output=srun_outputs/classification/SS_sup_vits16_100_%j.out
#SBATCH --error=srun_outputs/classification/SS_sup_vits16_100_%j.err
#SBATCH --time=04:00:00
#SBATCH --job-name=SS_sup
#SBATCH --gres=gpu:4
...
--bands B13 \
--checkpoints_dir /p/project/hai_ssl4eo/wang_yi/ssl4eo-s12-dataset/src/benchmark/fullset_temp/checkpoints/sup/SS_vits16_100 \
--backbone vit_small \
--train_frac 1.0 \
--batchsize 64 \
--lr 0.1 \
